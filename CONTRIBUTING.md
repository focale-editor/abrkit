# Contributing to AbrKit

Thanks for helping improve AbrKit. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/abrkit/issues) before opening a new one.
...
AbrKit follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/abrkit.git
cd abrkit
dart pub get
```
